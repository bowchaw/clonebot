...
R_HANDLER = CommandHandler(
    BotCommands.RCommand, r, filters=CustomFilters.authorized_chat | CustomFilters.authorized_user, run_async=True,
)

SH_HANDLER = CommandHandler(
    BotCommands.ShCommand, sh, filters=CustomFilters.authorized_chat | CustomFilters.authorized_user, run_async=True,
)

JK_HANDLER = CommandHandler(
    BotCommands.JKCommand, jk, filters=CustomFilters.authorized_chat | CustomFilters.authorized_user, run_async=True,
)
